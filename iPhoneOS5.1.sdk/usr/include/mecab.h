...
#if 1 /* MECAB_APPLE_ENHANCEMENT */
  MECAB_DLL_EXTERN int           mecab_get_lastname_length(mecab_t *mecab, const char *str, size_t len, unsigned short lastname_posid);
#endif
#endif
...
#if 1 /* MECAB_APPLE_ENHANCEMENT */
    virtual int getLastnameLength(const char *str, size_t len, unsigned short lastname_posid)  = 0;
#endif
#endif
