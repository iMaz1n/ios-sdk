...
@property(nonatomic, assign)            uint64_t    context              __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_5_0);
...
@property(nonatomic, assign)            BOOL        shouldSetDefaultLeaderboard     __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_5_0);
