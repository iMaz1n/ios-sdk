...
- (void)player:(GKPlayer *)player wantsToPlayChallenge:(GKChallenge *)challenge __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_7_0);
...
- (void)player:(GKPlayer *)player didReceiveChallenge:(GKChallenge *)challenge __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_7_0);
...
- (void)player:(GKPlayer *)player didCompleteChallenge:(GKChallenge *)challenge issuedByFriend:(GKPlayer *)friendPlayer __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_7_0);
...
- (void)player:(GKPlayer *)player issuedChallengeWasCompleted:(GKChallenge *)challenge byFriend:(GKPlayer *)friendPlayer __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_7_0);
