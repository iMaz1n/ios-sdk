...
// 2-bit: personality index
//
// 4-bits: 1=frame-based, 2=leaf, 3=dwarf
//  frame-based:
//        4-bits D reg pairs saved
//        4-bits X reg pairs saved
//  leaf:
//        no-bits  
//  dwarf:
...
//    range right below the saved FP/LR pair.  Any subset of the four X pairs 
//    and four D pairs can be saved, but the memory layout must be in register
//    number order.  
// UNWIND_ARM64_MODE_LEAF:
//    A "frameless" leaf function, where no non-volatile registers are saved.
//    The return remains in LR throughout the function.
