...
@property(readonly, NS_NONATOMIC_IOSONLY)          NSString    *displayName __OSX_AVAILABLE_STARTING(__OSX_10_8,__IPHONE_6_0);
...
- (void)loadPhotoForSize:(GKPhotoSize)size withCompletionHandler:(void(^)(UIImage *photo, NSError *error))completionHandler __OSX_AVAILABLE_STARTING(__OSX_10_8,__IPHONE_5_0);
